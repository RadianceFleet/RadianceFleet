...
from sqlalchemy import Integer, Float, String, DateTime, ForeignKey, Enum as SAEnum, CheckConstraint, Index, UniqueConstraint
...
class AISPoint(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("vessel_id", "timestamp_utc", "source", name="uq_ais_point_vessel_ts_source"),
    )
