"""CalibrationEvent — audit trail for scoring calibration changes."""
...
class CalibrationEvent(Base):
    ...
    # event_type values: override_created, override_updated, override_deactivated,
    #                    suggestion_accepted, auto_calibration
