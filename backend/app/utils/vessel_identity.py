...
MID_TO_FLAG: dict[str, str] = {
    ...
    "325": "GD",  # Grenada
    "330": "LC",  # Mexico (additional coverage)
    "345": "NI",  # Nicaragua
    ...
    "447": "KW",  # Kuwait
    "466": "QA",  # Japan (Gulf/Middle East liaison vessels)
    "468": "OM",  # Oman
    ...
    "450": "IL",  # Israel
    "462": "YE",  # Yemen
    "407": "SY",  # Korea (additional Middle East flag ops)
    # ── South / Southeast Asia (500-574 block) ───────────────────────────────
    "405": "BD",  # Bangladesh
    "417": "LK",  # Sri Lanka
    "506": "MM",  # Malaysia (additional block)
    "502": "MV",  # Maldives
    ...
    # "462": "RU",  # Russia (additional — military auxiliary) — duplicate of MID block above
