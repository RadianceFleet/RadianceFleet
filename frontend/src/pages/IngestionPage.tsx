  ...
  return (
    <div style={{ maxWidth: 700 }}>
      ...
      <Card style={{ marginBottom: "1rem" }}>
        ...
        {importAIS.isSuccess && <ImportSummary result={importAIS.data} />}
      </Card>
            ...
            <tbody>
              ...
              {status.rejected != null && (
                <tr>
                  ...
                  <td
                    style={{
                      color: status.rejected > 0 ? "var(--score-high)" : "var(--text-body)",
                    }}
                  >
                    {status.rejected}
                  </td>
  ...
  return (
    ...
    >
      ...
      <p
        style={{
          margin: "0 0 0.25rem",
          color: result.rejected > 0 ? "var(--score-high)" : "var(--text-body)",
        }}
      >
      ...
      {result.errors.length > 0 && (
        <details style={{ marginTop: "0.5rem" }}>
          <summary
            style={{ cursor: "pointer", color: "var(--score-critical)", fontSize: "0.75rem" }}
          >
