    ...
    <div style={{ maxWidth: 680 }}>
      ...
      <div style={card}>
        ...
        <p style={{ margin: "0 0 8px", fontSize: 14, lineHeight: 1.6 }}>
          RadianceFleet is open source maritime anomaly detection for journalists, OSINT
          researchers, and NGO analysts investigating the Russian shadow oil fleet. We process AIS
          data from multiple sources to surface suspicious vessel behavior for human investigation.
        </p>
        <p style={{ margin: 0, fontSize: 13, color: "var(--text-dim)", lineHeight: 1.6 }}>
          Outputs are anomaly indicators for human investigation -- not legal determinations. All
          findings require independent verification before publication.
        </p>
      </div>
      ...
      <div style={card}>
        ...
        <p style={{ margin: "0 0 14px", fontSize: 14, lineHeight: 1.6 }}>
          ...
          monthly infrastructure costs. Even $5/month from a few supporters keeps the platform
          running.
        </p>

        <h3 style={{ margin: "0 0 6px", fontSize: 15, color: "var(--text-muted)" }}>
        ...
        <p style={{ margin: 0, fontSize: 13, color: "var(--text-dim)" }}>
          If you represent a journalism or human rights organization interested in partnering, reach
      ...
      <div style={card}>
        ...
        <ul style={{ fontSize: 14, lineHeight: 1.9, paddingLeft: 20, margin: 0 }}>
          <li>
            <strong>Global Fishing Watch (GFW)</strong> -- dark gaps, vessel encounters, port visits
            (1-3 day lag)
          </li>
          <li>
            <strong>Kystverket</strong> -- Norwegian AIS (North Sea, Baltic, Barents Sea, real-time)
          </li>
          <li>
            <strong>Digitraffic</strong> -- Finnish AIS (Baltic, Gulf of Finland, near real-time)
          </li>
          <li>
            <strong>CREA Russia Fossil Tracker</strong> -- Russian oil export tracking (daily)
          </li>
        </ul>
      </div>
    </div>
