    ...
    <div style={{ maxWidth: 1100 }}>
      ...
      <Card style={{ marginBottom: '1rem' }}>
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          {['pending', 'auto_merged', 'analyst_merged', 'rejected'].map(s => (
            <button
              ...
              style={{
                ...
                background: statusFilter === s && viewMode === 'table' ? 'var(--accent)' : 'var(--bg-base)',
          ...
          <span style={{ marginLeft: 'auto', fontSize: 13, color: 'var(--text-muted)' }}>View:</span>
      ...
      {viewMode === 'graph' && (
        <Card>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: 8 }}>
                ...
                <span style={{
                  ...
                  color: chain.confidence_band === 'HIGH' ? '#22c55e'
                    : chain.confidence_band === 'MEDIUM' ? '#f59e0b'
                    : '#ef4444',
                }}>
          ...
          {chainsQuery.data?.total != null && chainsQuery.data.total > 50 && (
            <div style={{ marginTop: 8, fontSize: 13, color: 'var(--text-muted)', padding: '0 12px 12px' }}>
