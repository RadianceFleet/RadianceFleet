    ...
    <div>
      ...
      {!isLoading && !error && displayAlerts.length === 0 && (
        <EmptyState
          ...
          description={
            patternsOnly
              ? "No recurring patterns found. Try disabling the patterns filter."
              : "Adjust filters or run: make detect"
          }
        />
      )}
                ...
                <tr key={a.gap_event_id} style={tbodyRow}>
                  ...
                  <td style={tdStyle}>
                    ...
                    {a.is_recurring_pattern && (
                      ...
                      >
                        Recurring
                        {a.prior_similar_count != null ? ` (${a.prior_similar_count} in 90d)` : ""}
                      </span>
                    )}
                  </td>
                </tr>
