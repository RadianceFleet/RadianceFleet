  ...
  return (
    <ResponsiveContainer width="100%" height={240}>
      <LineChart data={data} margin={{ top: 4, right: 12, bottom: 4, left: 0 }}>
        ...
        <Line type="monotone" dataKey="gap_count" stroke="var(--score-critical)" name="Gaps" dot={false} />
        <Line type="monotone" dataKey="distinct_vessels" stroke="var(--accent)" name="Vessels" dot={false} />
        <Line type="monotone" dataKey="avg_risk_score" stroke="var(--warning)" name="Avg Risk" dot={false} />
      </LineChart>
    </ResponsiveContainer>
  )
}
